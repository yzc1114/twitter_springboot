...
CREATE SEQUENCE SEQ_USER_PUBLIC_INFO start with 1 increment by 1;
...
--!!!!��Ҫ User_Private_Info����Ҫ��Sequence����ʾ����������������ʱ��ʹ�ö�Ӧ��User_Public_Info�е�user_id����
...
CREATE SEQUENCE SEQ_AVATAR_IMAGE start with 1 increment by 1;
...
CREATE SEQUENCE SEQ_PRIVATE_LETTER start with 1 increment by 1;
...
CREATE TABLE Likes(
  ...
  PRIMARY KEY(likes_user_id, likes_message_id),
...
CREATE SEQUENCE SEQ_COMMENT_ON_MESSAGE start with 1 increment by 1;
...
CREATE SEQUENCE SEQ_TOPIC start with 1 increment by 1;
