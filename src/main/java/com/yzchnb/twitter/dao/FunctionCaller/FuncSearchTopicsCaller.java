...
import com.yzchnb.twitter.dao.FunctionMapper.FuncSearchTopicsMapper;
...
@Repository
public class FuncSearchTopicsCaller extends FuncBaseCaller {
	@Autowired
	private FuncSearchTopicsMapper funcSearchTopicsMapper;
	...
	public java.util.ArrayList call(java.lang.String searchkey, java.lang.Integer startfrom, java.lang.Integer limitation){
		...
		return resolveArrayList(funcSearchTopicsMapper, map);
	}
}
